        ...
        <div id="planner-content">
            ...
            <div id="planner-appointments-section" class="box-in">
                ...
                <div id="planner-appointments-rows">
                    <%
                        //for (AppointmentBean appointment: planner.getAppointments()) {
                        int hours = 9;
                        String minutes = "00";
                        int appointmentsSlotsNumber = 10;
                        for (int i = 2; i < appointmentsSlotsNumber; i++, hours++) {
                    %>
                    <div id="planner-<%=i%>nd-row" class="planner-row">
                        <div class="planner-column planner-time">
