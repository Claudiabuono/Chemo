        ...
        <div id="add-patient-form" class="form">
            ...
            <div class="input-fields-row">
                <div class="field left">
                    ...
                    <p id="name-validity" class="validity-paragraph status-unavaliable"></p>
                </div>
                <div class="field right">
                    <label for="surname">Cognome</label>
                    <input required id="surname" class="input-field" type="text" name="surname">
                    <p id="surname-validity" class="validity-paragraph status-unavaliable"></p>
                </div>
            </div>
            <div class="input-fields-row">
                <div class="field left">
                    ...
                    <p id="birthdate-validity" class="validity-paragraph status-unavaliable"></p>
                </div>
                <div class="field right">
                    <label for="city">Città di nascita</label>
                    <input required id="city" class="input-field" type="text" name="city">
                    <p id="city-validity" class="validity-paragraph status-unavaliable"></p>
                </div>
            </div>
            <div class="input-fields-row">
                <div class="field left">
                    ...
                    <p id="tax-code-validity" class="validity-paragraph status-unavaliable"></p>
                </div>
            </div>
            <div class="title-section">
            ...
            <div class="input-fields-row">
                <div class="field left">
                    ...
                    <p id="phone-number-validity" class="validity-paragraph status-unavaliable"></p>
                </div>
            </div>
            <div class="title-section">
            ...
            <p id="notes-validity" class="validity-paragraph status-unavaliable"></p>
